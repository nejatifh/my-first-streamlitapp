...
# %%
# Internet share Data Exploration
df = pd.read_csv('../data/share-of-individuals-using-the-internet.csv')
df.head(15)
df.shape # (7119, 4)

# df_energy = pd.read_csv('../data/renewable_power_plants_CH.csv')
# df_energy.shape # (12718, 22)

# df_dog = pd.read_csv('../data/20200306_hundehalter.csv')
# df_dog.shape # (7841, 13)


# df_volc = pd.read_csv('../data/volcano_ds_pop.csv')
# df_volc.shape # (1426, 12)
# %%
st.table(data=df)
